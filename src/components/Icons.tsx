...
export function HeartIcon({ size = 17, filled = false }: { size?: number; filled?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24">
      <path
        d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"
        fill={filled ? '#0a0a0a' : 'none'}
        stroke={filled ? '#0a0a0a' : '#bdbdbd'}
        strokeWidth="1.8"
...
export function FilterIcon({ color = 'currentColor' }: { color?: string }) {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15">
      <path d="M1.5 3.5h12M3.5 7.5h8M6 11.5h3" stroke={color} strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  )
}
